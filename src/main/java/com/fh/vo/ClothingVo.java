...
public class ClothingVo {
    ...
    public ClothingVo(Integer clo_id, String clo_trademark, Integer clo_Racking, Integer clo_season, String clo_person, Integer clo_price, Date clo_dateTime, Integer clo_discount, String seasonNname) {
        this.clo_id = clo_id;
        this.clo_trademark = clo_trademark;
        this.clo_Racking = clo_Racking;
        this.clo_season = clo_season;
